ace.define('ace/mode/maze_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const MazeHighlightRules = function () {
    this.$rules = {
      start: [{
...
ace.define('ace/mode/maze', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/maze_highlight_rules', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const MazeHighlightRules = acequire('./maze_highlight_rules').MazeHighlightRules;
