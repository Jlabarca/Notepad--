...
ace.define('ace/mode/jsx_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/doc_comment_highlight_rules', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const lang = acequire('../lib/lang');
  const DocCommentHighlightRules = acequire('./doc_comment_highlight_rules').DocCommentHighlightRules;
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const JsxHighlightRules = function () {
    const keywords = lang.arrayToMap(('break|do|instanceof|typeof|case|else|new|var|catch|finally|return|void|continue|for|switch|default|while|function|this|' +
         'if|throw|' +
         'delete|in|try|' +
    ...
    const buildinConstants = lang.arrayToMap(('null|true|false|NaN|Infinity|__FILE__|__LINE__|undefined').split('|'));

    const reserved = lang.arrayToMap(('debugger|with|' +
         'const|export|' +
...
ace.define('ace/mode/jsx', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/jsx_highlight_rules', 'ace/mode/matching_brace_outdent', 'ace/mode/behaviour/cstyle', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const JsxHighlightRules = acequire('./jsx_highlight_rules').JsxHighlightRules;
