...
ace.define('ace/mode/coldfusion_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/javascript_highlight_rules', 'ace/mode/html_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const JavaScriptHighlightRules = acequire('./javascript_highlight_rules').JavaScriptHighlightRules;
  const HtmlHighlightRules = acequire('./html_highlight_rules').HtmlHighlightRules;
...
ace.define('ace/mode/coldfusion', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/html', 'ace/mode/coldfusion_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const lang = acequire('../lib/lang');
  const HtmlMode = acequire('./html').Mode;
  const ColdfusionHighlightRules = acequire('./coldfusion_highlight_rules').ColdfusionHighlightRules;
