ace.define('ace/mode/kotlin_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const KotlinHighlightRules = function () {
    this.$rules = {
      start: [{
        include: '#comments',
      }, {
...
ace.define('ace/mode/kotlin', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/kotlin_highlight_rules', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const KotlinHighlightRules = acequire('./kotlin_highlight_rules').KotlinHighlightRules;
