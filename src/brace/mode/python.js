...
ace.define('ace/mode/python', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/python_highlight_rules', 'ace/mode/folding/pythonic', 'ace/range'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
