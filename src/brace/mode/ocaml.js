ace.define('ace/mode/ocaml_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const OcamlHighlightRules = function () {
    const keywords = (
...
ace.define('ace/mode/ocaml', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/ocaml_highlight_rules', 'ace/mode/matching_brace_outdent', 'ace/range'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const OcamlHighlightRules = acequire('./ocaml_highlight_rules').OcamlHighlightRules;
  ...
  const indenter = /(?:[({[=:]|[-=]>|\b(?:else|try|with))\s*$/;
