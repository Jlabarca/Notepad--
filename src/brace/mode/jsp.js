...
ace.define('ace/mode/jsp_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html_highlight_rules', 'ace/mode/java_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  ...
  const JspHighlightRules = function () {
    HtmlHighlightRules.call(this);

    const builtinVariables = 'request|response|out|session|' +
            'application|config|pageContext|page|Exception';

    const keywords = 'page|include|taglib';
...
ace.define('ace/mode/jsp', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/jsp_highlight_rules', 'ace/mode/matching_brace_outdent', 'ace/mode/behaviour/cstyle', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const JspHighlightRules = acequire('./jsp_highlight_rules').JspHighlightRules;
