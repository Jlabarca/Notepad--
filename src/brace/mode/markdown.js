...
ace.define('ace/mode/xml', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/text', 'ace/mode/xml_highlight_rules', 'ace/mode/behaviour/xml', 'ace/mode/folding/xml', 'ace/worker/worker_client'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const lang = acequire('../lib/lang');
  const TextMode = acequire('./text').Mode;
  ...
  const XmlFoldMode = acequire('./folding/xml').FoldMode;
  const WorkerClient = acequire('../worker/worker_client').WorkerClient;
  ...
  (function () {
    ...
    this.createWorker = function (session) {
      const worker = new WorkerClient(['ace'], require('../worker/xml'), 'Worker');
      worker.attachToDocument(session.getDocument());
...
ace.define('ace/mode/markdown_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/text_highlight_rules', 'ace/mode/javascript_highlight_rules', 'ace/mode/xml_highlight_rules', 'ace/mode/html_highlight_rules', 'ace/mode/css_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const lang = acequire('../lib/lang');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;
  const JavaScriptHighlightRules = acequire('./javascript_highlight_rules').JavaScriptHighlightRules;
...
ace.define('ace/mode/folding/markdown', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/folding/fold_mode', 'ace/range'], (acequire, exports, module) => {
  const oop = acequire('../../lib/oop');
  const BaseFoldMode = acequire('./fold_mode').FoldMode;
  const Range = acequire('../../range').Range;
...
ace.define('ace/mode/markdown', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/javascript', 'ace/mode/xml', 'ace/mode/html', 'ace/mode/markdown_highlight_rules', 'ace/mode/folding/markdown'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const JavaScriptMode = acequire('./javascript').Mode;
  const XmlMode = acequire('./xml').Mode;
  const HtmlMode = acequire('./html').Mode;
  const MarkdownHighlightRules = acequire('./markdown_highlight_rules').MarkdownHighlightRules;
  const MarkdownFoldMode = acequire('./folding/markdown').FoldMode;
