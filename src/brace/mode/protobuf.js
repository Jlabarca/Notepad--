...
ace.define('ace/mode/protobuf_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const ProtobufHighlightRules = function () {
    const builtinTypes = 'double|float|int32|int64|uint32|uint64|sint32|' +
                           'sint64|fixed32|fixed64|sfixed32|sfixed64|bool|' +
                           'string|bytes';
    const keywordDeclaration = 'message|acequired|optional|repeated|package|' +
                                 'import|option|enum';
...
ace.define('ace/mode/protobuf', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/c_cpp', 'ace/mode/protobuf_highlight_rules', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const CMode = acequire('./c_cpp').Mode;
  const ProtobufHighlightRules = acequire('./protobuf_highlight_rules').ProtobufHighlightRules;
  const CStyleFoldMode = acequire('./folding/cstyle').FoldMode;
