...
ace.define('ace/mode/nix_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const NixHighlightRules = function () {
    const constantLanguage = 'true|false';
    const keywordControl = 'with|import|if|else|then|inherit';
    const keywordDeclaration = 'let|in|rec';
...
ace.define('ace/mode/nix', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/c_cpp', 'ace/mode/nix_highlight_rules', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const CMode = acequire('./c_cpp').Mode;
  const NixHighlightRules = acequire('./nix_highlight_rules').NixHighlightRules;
  const CStyleFoldMode = acequire('./folding/cstyle').FoldMode;
