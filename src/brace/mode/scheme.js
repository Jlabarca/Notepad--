ace.define('ace/mode/scheme_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
...
ace.define('ace/mode/scheme', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/scheme_highlight_rules', 'ace/mode/matching_parens_outdent'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const SchemeHighlightRules = acequire('./scheme_highlight_rules').SchemeHighlightRules;
