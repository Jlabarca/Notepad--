...
ace.define('ace/mode/stylus_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules', 'ace/mode/css_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;
  const CssHighlightRules = acequire('./css_highlight_rules');

  const StylusHighlightRules = function () {
    const keywordMapper = this.createKeywordMapper({
...
ace.define('ace/mode/stylus', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/stylus_highlight_rules', 'ace/mode/folding/coffee'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const StylusHighlightRules = acequire('./stylus_highlight_rules').StylusHighlightRules;
