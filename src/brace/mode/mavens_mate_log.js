...
ace.define('ace/mode/mavens_mate_log', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/mavens_mate_log_highlight_rules', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const MavensMateLogHighlightRules = acequire('./mavens_mate_log_highlight_rules').MavensMateLogHighlightRules;
