...
ace.define('ace/mode/folding/csharp', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/range', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../../lib/oop');
  const Range = acequire('../../range').Range;
  const CFoldMode = acequire('./cstyle').FoldMode;
...
ace.define('ace/mode/csharp', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/csharp_highlight_rules', 'ace/mode/matching_brace_outdent', 'ace/mode/behaviour/cstyle', 'ace/mode/folding/csharp'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  ...
  const CStyleFoldMode = acequire('./folding/csharp').FoldMode;
