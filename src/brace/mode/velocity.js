...
ace.define('ace/mode/velocity_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/text_highlight_rules', 'ace/mode/html_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const lang = acequire('../lib/lang');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;
  const HtmlHighlightRules = acequire('./html_highlight_rules').HtmlHighlightRules;

  const VelocityHighlightRules = function () {
    HtmlHighlightRules.call(this);

    const builtinConstants = lang.arrayToMap(('true|false|null').split('|'));

    const builtinFunctions = lang.arrayToMap(('_DateTool|_DisplayTool|_EscapeTool|_FieldTool|_MathTool|_NumberTool|_SerializerTool|_SortTool|_StringTool|_XPathTool').split('|'));

    const builtinVariables = lang.arrayToMap(('$contentRoot|$foreach').split('|'));

    const keywords = lang.arrayToMap(('#set|#macro|#include|#parse|' +
...
ace.define('ace/mode/folding/velocity', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/folding/fold_mode', 'ace/range'], (acequire, exports, module) => {
  const oop = acequire('../../lib/oop');
  const BaseFoldMode = acequire('./fold_mode').FoldMode;
  const Range = acequire('../../range').Range;
...
ace.define('ace/mode/velocity', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html', 'ace/mode/velocity_highlight_rules', 'ace/mode/folding/velocity'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const HtmlMode = acequire('./html').Mode;
  const VelocityHighlightRules = acequire('./velocity_highlight_rules').VelocityHighlightRules;
  const FoldMode = acequire('./folding/velocity').FoldMode;
