...
ace.define('ace/mode/coffee', ['require', 'exports', 'module', 'ace/mode/coffee_highlight_rules', 'ace/mode/matching_brace_outdent', 'ace/mode/folding/coffee', 'ace/range', 'ace/mode/text', 'ace/worker/worker_client', 'ace/lib/oop'], (acequire, exports, module) => {
  const Rules = acequire('./coffee_highlight_rules').CoffeeHighlightRules;
  const Outdent = acequire('./matching_brace_outdent').MatchingBraceOutdent;
  ...
  (function () {
    ...
    this.createWorker = function (session) {
      const worker = new WorkerClient(['ace'], require('../worker/coffee'), 'Worker');
