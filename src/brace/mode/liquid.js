...
ace.define('ace/mode/liquid_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules', 'ace/mode/html_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;
  const HtmlHighlightRules = acequire('./html_highlight_rules').HtmlHighlightRules;

  const LiquidHighlightRules = function () {
    ...
    const builtinVariables = 'forloop|tablerowloop';

    const definitions = ('assign');
...
ace.define('ace/mode/liquid', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/liquid_highlight_rules', 'ace/mode/matching_brace_outdent'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const LiquidHighlightRules = acequire('./liquid_highlight_rules').LiquidHighlightRules;
