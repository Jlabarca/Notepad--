ace.define('ace/mode/julia_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const JuliaHighlightRules = function () {
    this.$rules = {
      start:
...
ace.define('ace/mode/julia', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/julia_highlight_rules', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const JuliaHighlightRules = acequire('./julia_highlight_rules').JuliaHighlightRules;
