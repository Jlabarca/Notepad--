ace.define('ace/mode/css_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  ...
  const supportConstantColor = exports.supportConstantColor = 'aqua|black|blue|fuchsia|gray|green|lime|maroon|navy|olive|orange|purple|red|silver|teal|white|yellow';
...
ace.define('ace/mode/swig', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/html_highlight_rules', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const lang = acequire('../lib/lang');
  const HtmlHighlightRules = acequire('./html_highlight_rules').HtmlHighlightRules;
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const SwigHighlightRules = function () {
    HtmlHighlightRules.call(this);

    let tags = 'autoescape|block|else|elif|extends|filter|for|if|import|include|macro|parent|raw|set|spaceless';
    tags = `${tags}|end${tags.replace(/\|/g, '|end')}`;
    const filters = 'addslashes|capitalize|date|default|escape|first|groupBy|join|json|last|lower|raw|replace|reverse|safe|sort|striptags|title|uniq|upper|url_encode|url_decode';
    const special = 'first|last|index|index0|revindex|revindex0|key';
    const constants = 'null|none|true|false|loop';
    const operators = 'in|is|and|or|not|as|with|only';
