...
ace.define('ace/mode/swift_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/doc_comment_highlight_rules', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const lang = acequire('../lib/lang');
  const DocCommentHighlightRules = acequire('./doc_comment_highlight_rules').DocCommentHighlightRules;
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const SwiftHighlightRules = function () {
    ...
    function string(start, options) {
      const nestable = options.nestable || options.interpolation;
      const interpStart = options.interpolation && options.interpolation.nextState || 'start';
      const mainRule = {
      ...
      const open = options.interpolation.open;
      const close = options.interpolation.close;
      const counter = {
...
ace.define('ace/mode/swift', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/swift_highlight_rules', 'ace/mode/behaviour/cstyle', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const HighlightRules = acequire('./swift_highlight_rules').HighlightRules;
