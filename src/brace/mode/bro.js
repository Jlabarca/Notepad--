ace.define('ace/mode/bro_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
...
ace.define('ace/mode/bro', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/bro_highlight_rules', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const BroHighlightRules = acequire('./bro_highlight_rules').BroHighlightRules;
