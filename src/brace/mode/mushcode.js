ace.define('ace/mode/mushcode_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const MushCodeRules = function () {
    const keywords = (
      '@if|' +
 '@ifelse|' +
 '@switch|' +
...
ace.define('ace/mode/folding/pythonic', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/folding/fold_mode'], (acequire, exports, module) => {
  const oop = acequire('../../lib/oop');
...
ace.define('ace/mode/mushcode', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/mushcode_highlight_rules', 'ace/mode/folding/pythonic', 'ace/range'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const MushCodeRules = acequire('./mushcode_highlight_rules').MushCodeRules;
  const PythonFoldMode = acequire('./folding/pythonic').FoldMode;
