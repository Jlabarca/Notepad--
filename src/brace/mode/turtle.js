ace.define('ace/mode/turtle_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const TurtleHighlightRules = function () {
    this.$rules = {
      start: [{
        include: '#comments',
      }, {
...
ace.define('ace/mode/turtle', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/turtle_highlight_rules', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const TurtleHighlightRules = acequire('./turtle_highlight_rules').TurtleHighlightRules;
