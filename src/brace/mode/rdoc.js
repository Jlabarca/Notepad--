...
ace.define('ace/mode/rdoc_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/text_highlight_rules', 'ace/mode/latex_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const lang = acequire('../lib/lang');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;
  const LaTeXHighlightRules = acequire('./latex_highlight_rules');
...
ace.define('ace/mode/rdoc', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/rdoc_highlight_rules', 'ace/mode/matching_brace_outdent'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const RDocHighlightRules = acequire('./rdoc_highlight_rules').RDocHighlightRules;
