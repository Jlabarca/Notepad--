...
ace.define('ace/mode/dockerfile_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/sh_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const ShHighlightRules = acequire('./sh_highlight_rules').ShHighlightRules;
...
ace.define('ace/mode/dockerfile', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/sh', 'ace/mode/dockerfile_highlight_rules', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const ShMode = acequire('./sh').Mode;
  const DockerfileHighlightRules = acequire('./dockerfile_highlight_rules').DockerfileHighlightRules;
  const CStyleFoldMode = acequire('./folding/cstyle').FoldMode;
