...
ace.define('ace/mode/svg_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/javascript_highlight_rules', 'ace/mode/xml_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const JavaScriptHighlightRules = acequire('./javascript_highlight_rules').JavaScriptHighlightRules;
  const XmlHighlightRules = acequire('./xml_highlight_rules').XmlHighlightRules;

  const SvgHighlightRules = function () {
...
ace.define('ace/mode/svg', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/xml', 'ace/mode/javascript', 'ace/mode/svg_highlight_rules', 'ace/mode/folding/mixed', 'ace/mode/folding/xml', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const XmlMode = acequire('./xml').Mode;
  const JavaScriptMode = acequire('./javascript').Mode;
  const SvgHighlightRules = acequire('./svg_highlight_rules').SvgHighlightRules;
  const MixedFoldMode = acequire('./folding/mixed').FoldMode;
  const XmlFoldMode = acequire('./folding/xml').FoldMode;
  const CStyleFoldMode = acequire('./folding/cstyle').FoldMode;
