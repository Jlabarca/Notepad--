...
ace.define('ace/mode/scss', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/scss_highlight_rules', 'ace/mode/matching_brace_outdent', 'ace/mode/behaviour/css', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const ScssHighlightRules = acequire('./scss_highlight_rules').ScssHighlightRules;
