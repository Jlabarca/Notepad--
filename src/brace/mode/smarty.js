...
ace.define('ace/mode/smarty_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const HtmlHighlightRules = acequire('./html_highlight_rules').HtmlHighlightRules;

  const SmartyHighlightRules = function () {
    ...
    const smartyStart = smartyRules.start;
...
ace.define('ace/mode/smarty', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html', 'ace/mode/smarty_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const HtmlMode = acequire('./html').Mode;
  const SmartyHighlightRules = acequire('./smarty_highlight_rules').SmartyHighlightRules;
