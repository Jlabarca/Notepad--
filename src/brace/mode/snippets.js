...
ace.define('ace/mode/snippets', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/text_highlight_rules', 'ace/mode/folding/coffee'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const SnippetHighlightRules = function () {
    const builtins = 'SELECTION|CURRENT_WORD|SELECTED_TEXT|CURRENT_LINE|LINE_INDEX|' +
  ...
  const SnippetGroupHighlightRules = function () {
    this.$rules = {
      start: [
