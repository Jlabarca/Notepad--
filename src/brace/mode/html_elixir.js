...
ace.define('ace/mode/elixir_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;
...
ace.define('ace/mode/html_elixir_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html_highlight_rules', 'ace/mode/elixir_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const HtmlHighlightRules = acequire('./html_highlight_rules').HtmlHighlightRules;
  const ElixirHighlightRules = acequire('./elixir_highlight_rules').ElixirHighlightRules;
...
ace.define('ace/mode/elixir', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/elixir_highlight_rules', 'ace/mode/folding/coffee'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const ElixirHighlightRules = acequire('./elixir_highlight_rules').ElixirHighlightRules;
...
ace.define('ace/mode/html_elixir', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html_elixir_highlight_rules', 'ace/mode/html', 'ace/mode/javascript', 'ace/mode/css', 'ace/mode/elixir'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const HtmlElixirHighlightRules = acequire('./html_elixir_highlight_rules').HtmlElixirHighlightRules;
  const HtmlMode = acequire('./html').Mode;
  const JavaScriptMode = acequire('./javascript').Mode;
  const CssMode = acequire('./css').Mode;
  const ElixirMode = acequire('./elixir').Mode;
