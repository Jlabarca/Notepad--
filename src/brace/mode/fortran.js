ace.define('ace/mode/fortran_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
...
ace.define('ace/mode/fortran', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/fortran_highlight_rules', 'ace/mode/folding/cstyle', 'ace/range'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const FortranHighlightRules = acequire('./fortran_highlight_rules').FortranHighlightRules;
