ace.define('ace/mode/vala_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const ValaHighlightRules = function () {
    this.$rules = {
      start:
       [{
         token:
...
ace.define('ace/mode/vala', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/tokenizer', 'ace/mode/vala_highlight_rules', 'ace/mode/folding/cstyle', 'ace/mode/behaviour/cstyle', 'ace/mode/folding/cstyle', 'ace/mode/matching_brace_outdent'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const Tokenizer = acequire('../tokenizer').Tokenizer;
  const ValaHighlightRules = acequire('./vala_highlight_rules').ValaHighlightRules;
