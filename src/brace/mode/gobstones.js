...
ace.define('ace/mode/gobstones_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/doc_comment_highlight_rules', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const DocCommentHighlightRules = acequire('./doc_comment_highlight_rules').DocCommentHighlightRules;
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;
...
ace.define('ace/mode/gobstones', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/javascript', 'ace/mode/gobstones_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const JavaScriptMode = acequire('./javascript').Mode;
  const GobstonesHighlightRules = acequire('./gobstones_highlight_rules').GobstonesHighlightRules;
