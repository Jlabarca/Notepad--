...
ace.define('ace/mode/curly_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const HtmlHighlightRules = acequire('./html_highlight_rules').HtmlHighlightRules;
...
ace.define('ace/mode/curly', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html', 'ace/mode/matching_brace_outdent', 'ace/mode/folding/html', 'ace/mode/curly_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const HtmlMode = acequire('./html').Mode;
  const MatchingBraceOutdent = acequire('./matching_brace_outdent').MatchingBraceOutdent;
  const HtmlFoldMode = acequire('./folding/html').FoldMode;
  const CurlyHighlightRules = acequire('./curly_highlight_rules').CurlyHighlightRules;
