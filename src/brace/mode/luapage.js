...
ace.define('ace/mode/lua_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;
...
ace.define('ace/mode/folding/lua', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/folding/fold_mode', 'ace/range', 'ace/token_iterator'], (acequire, exports, module) => {
  const oop = acequire('../../lib/oop');
  const BaseFoldMode = acequire('./fold_mode').FoldMode;
  const Range = acequire('../../range').Range;
  const TokenIterator = acequire('../../token_iterator').TokenIterator;
...
ace.define('ace/mode/lua', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/lua_highlight_rules', 'ace/mode/folding/lua', 'ace/range', 'ace/worker/worker_client'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const LuaHighlightRules = acequire('./lua_highlight_rules').LuaHighlightRules;
  const LuaFoldMode = acequire('./folding/lua').FoldMode;
  const Range = acequire('../range').Range;
  const WorkerClient = acequire('../worker/worker_client').WorkerClient;
  ...
  (function () {
    ...
    this.createWorker = function (session) {
      const worker = new WorkerClient(['ace'], require('../worker/lua'), 'Worker');
      worker.attachToDocument(session.getDocument());
...
ace.define('ace/mode/luapage_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html_highlight_rules', 'ace/mode/lua_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const HtmlHighlightRules = acequire('./html_highlight_rules').HtmlHighlightRules;
  const LuaHighlightRules = acequire('./lua_highlight_rules').LuaHighlightRules;

  const LuaPageHighlightRules = function () {
...
ace.define('ace/mode/luapage', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html', 'ace/mode/lua', 'ace/mode/luapage_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const HtmlMode = acequire('./html').Mode;
  const LuaMode = acequire('./lua').Mode;
  const LuaPageHighlightRules = acequire('./luapage_highlight_rules').LuaPageHighlightRules;
