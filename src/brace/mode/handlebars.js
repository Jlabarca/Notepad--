...
ace.define('ace/mode/handlebars_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const HtmlHighlightRules = acequire('./html_highlight_rules').HtmlHighlightRules;
...
ace.define('ace/mode/behaviour/html', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/behaviour/xml'], (acequire, exports, module) => {
  const oop = acequire('../../lib/oop');
  const XmlBehaviour = acequire('../behaviour/xml').XmlBehaviour;
...
ace.define('ace/mode/handlebars', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html', 'ace/mode/handlebars_highlight_rules', 'ace/mode/behaviour/html', 'ace/mode/folding/html'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const HtmlMode = acequire('./html').Mode;
  const HandlebarsHighlightRules = acequire('./handlebars_highlight_rules').HandlebarsHighlightRules;
  const HtmlBehaviour = acequire('./behaviour/html').HtmlBehaviour;
  const HtmlFoldMode = acequire('./folding/html').FoldMode;
