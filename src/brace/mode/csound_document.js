ace.define('ace/mode/csound_preprocessor_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
...
ace.define('ace/mode/csound_score_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/csound_preprocessor_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');

  const CsoundPreprocessorHighlightRules = acequire('./csound_preprocessor_highlight_rules').CsoundPreprocessorHighlightRules;
...
ace.define('ace/mode/python_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;
...
ace.define('ace/mode/csound_orchestra_highlight_rules', ['require', 'exports', 'module', 'ace/lib/lang', 'ace/lib/oop', 'ace/mode/csound_preprocessor_highlight_rules', 'ace/mode/csound_score_highlight_rules', 'ace/mode/lua_highlight_rules', 'ace/mode/python_highlight_rules'], (acequire, exports, module) => {
  const lang = acequire('../lib/lang');
  const oop = acequire('../lib/oop');

  const CsoundPreprocessorHighlightRules = acequire('./csound_preprocessor_highlight_rules').CsoundPreprocessorHighlightRules;
  const CsoundScoreHighlightRules = acequire('./csound_score_highlight_rules').CsoundScoreHighlightRules;
  const LuaHighlightRules = acequire('./lua_highlight_rules').LuaHighlightRules;
  const PythonHighlightRules = acequire('./python_highlight_rules').PythonHighlightRules;
...
ace.define('ace/mode/csound_document_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/csound_orchestra_highlight_rules', 'ace/mode/csound_score_highlight_rules', 'ace/mode/html_highlight_rules', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');

  const CsoundOrchestraHighlightRules = acequire('./csound_orchestra_highlight_rules').CsoundOrchestraHighlightRules;
  const CsoundScoreHighlightRules = acequire('./csound_score_highlight_rules').CsoundScoreHighlightRules;
...
ace.define('ace/mode/csound_document', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/csound_document_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const CsoundDocumentHighlightRules = acequire('./csound_document_highlight_rules').CsoundDocumentHighlightRules;
