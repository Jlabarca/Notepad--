...
ace.define('ace/mode/tex_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const lang = acequire('../lib/lang');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;
...
ace.define('ace/mode/r_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/text_highlight_rules', 'ace/mode/tex_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const lang = acequire('../lib/lang');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;
  const TexHighlightRules = acequire('./tex_highlight_rules').TexHighlightRules;

  const RHighlightRules = function () {
    const keywords = lang.arrayToMap(('function|if|in|break|next|repeat|else|for|return|switch|while|try|tryCatch|stop|warning|acequire|library|attach|detach|source|setMethod|setGeneric|setGroupGeneric|setClass')
      .split('|'));

    const buildinConstants = lang.arrayToMap(('NULL|NA|TRUE|FALSE|T|F|Inf|NaN|NA_integer_|NA_real_|NA_character_|' +
             'NA_complex_').split('|'));
    ...
    this.$rules = {
      start: [
        ...
        {
          onMatch(value) {
            if (keywords[value]) { return 'keyword'; } else if (buildinConstants[value]) { return 'constant.language'; } else if (value == '...' || value.match(/^\.\.\d+$/)) { return 'variable.language'; }
            return 'identifier';
          },
...
ace.define('ace/mode/rhtml_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/r_highlight_rules', 'ace/mode/html_highlight_rules', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const RHighlightRules = acequire('./r_highlight_rules').RHighlightRules;
  const HtmlHighlightRules = acequire('./html_highlight_rules').HtmlHighlightRules;
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const RHtmlHighlightRules = function () {
...
ace.define('ace/mode/rhtml', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html', 'ace/mode/rhtml_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const HtmlMode = acequire('./html').Mode;

  const RHtmlHighlightRules = acequire('./rhtml_highlight_rules').RHtmlHighlightRules;

  const Mode = function (doc, session) {
    HtmlMode.call(this);
