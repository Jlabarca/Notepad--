ace.define('ace/mode/mips_assembler_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
...
ace.define('ace/mode/mips_assembler', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/mips_assembler_highlight_rules', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const MIPSAssemblerHighlightRules = acequire('./mips_assembler_highlight_rules').MIPSAssemblerHighlightRules;
