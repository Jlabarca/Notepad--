ace.define('ace/mode/vhdl_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const VHDLHighlightRules = function () {
    const keywords = 'access|after|ailas|all|architecture|assert|attribute|' +
    ...
    const storageType = 'bit|bit_vector|boolean|character|integer|line|natural|' +
                      'positive|real|register|severity|signal|signed|' +
                      'std_logic|std_logic_vector|string||text|time|unsigned|' +
                      'variable';

    const storageModifiers = 'array|constant';

    const keywordOperators = 'abs|and|mod|nand|nor|not|rem|rol|ror|sla|sll|sra' +
                           'srl|xnor|xor';
...
ace.define('ace/mode/vhdl', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/vhdl_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const VHDLHighlightRules = acequire('./vhdl_highlight_rules').VHDLHighlightRules;
