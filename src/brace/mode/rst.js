ace.define('ace/mode/rst_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const lang = acequire('../lib/lang');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const RSTHighlightRules = function () {
    const tokens = {
    ...
    const startStringPrefix = "(^|\\s|[\"'(<\\[{\\-/:])";
    const endStringSuffix = "(?:$|(?=\\s|[\\\\.,;!?\\-/:\"')>\\]}]))";
...
ace.define('ace/mode/rst', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/rst_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const RSTHighlightRules = acequire('./rst_highlight_rules').RSTHighlightRules;
