...
ace.define('ace/mode/haml_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html_highlight_rules', 'ace/mode/ruby_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const HtmlHighlightRules = acequire('./html_highlight_rules').HtmlHighlightRules;
  const RubyExports = acequire('./ruby_highlight_rules');
...
ace.define('ace/mode/haml', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/haml_highlight_rules', 'ace/mode/folding/coffee'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const HamlHighlightRules = acequire('./haml_highlight_rules').HamlHighlightRules;
