...
ace.define('ace/mode/ruby_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;
...
ace.define('ace/mode/html_ruby_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html_highlight_rules', 'ace/mode/ruby_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const HtmlHighlightRules = acequire('./html_highlight_rules').HtmlHighlightRules;
  const RubyHighlightRules = acequire('./ruby_highlight_rules').RubyHighlightRules;
...
ace.define('ace/mode/ruby', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/ruby_highlight_rules', 'ace/mode/matching_brace_outdent', 'ace/range', 'ace/mode/behaviour/cstyle', 'ace/mode/folding/coffee'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const RubyHighlightRules = acequire('./ruby_highlight_rules').RubyHighlightRules;
  const MatchingBraceOutdent = acequire('./matching_brace_outdent').MatchingBraceOutdent;
...
ace.define('ace/mode/html_ruby', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html_ruby_highlight_rules', 'ace/mode/html', 'ace/mode/javascript', 'ace/mode/css', 'ace/mode/ruby'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const HtmlRubyHighlightRules = acequire('./html_ruby_highlight_rules').HtmlRubyHighlightRules;
  const HtmlMode = acequire('./html').Mode;
  const JavaScriptMode = acequire('./javascript').Mode;
  const CssMode = acequire('./css').Mode;
  const RubyMode = acequire('./ruby').Mode;
