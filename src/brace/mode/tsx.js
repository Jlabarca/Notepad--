...
ace.define('ace/mode/typescript_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/javascript_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const JavaScriptHighlightRules = acequire('./javascript_highlight_rules').JavaScriptHighlightRules;

  const TypeScriptHighlightRules = function (options) {
    const tsRules = [
      {
...
ace.define('ace/mode/typescript', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/javascript', 'ace/mode/typescript_highlight_rules', 'ace/mode/behaviour/cstyle', 'ace/mode/folding/cstyle', 'ace/mode/matching_brace_outdent'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const jsMode = acequire('./javascript').Mode;
  const TypeScriptHighlightRules = acequire('./typescript_highlight_rules').TypeScriptHighlightRules;
  const CstyleBehaviour = acequire('./behaviour/cstyle').CstyleBehaviour;
  const CStyleFoldMode = acequire('./folding/cstyle').FoldMode;
  const MatchingBraceOutdent = acequire('./matching_brace_outdent').MatchingBraceOutdent;
...
ace.define('ace/mode/tsx', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/typescript'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const tsMode = acequire('./typescript').Mode;
