...
ace.define('ace/mode/csound_orchestra', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/csound_orchestra_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
