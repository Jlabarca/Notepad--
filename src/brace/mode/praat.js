ace.define('ace/mode/praat_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const PraatHighlightRules = function () {
    const keywords = (
...
ace.define('ace/mode/praat', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/praat_highlight_rules', 'ace/mode/matching_brace_outdent', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const PraatHighlightRules = acequire('./praat_highlight_rules').PraatHighlightRules;
