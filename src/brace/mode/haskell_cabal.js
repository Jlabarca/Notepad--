ace.define('ace/mode/haskell_cabal_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
...
ace.define('ace/mode/folding/haskell_cabal', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/folding/fold_mode', 'ace/range'], (acequire, exports, module) => {
  const oop = acequire('../../lib/oop');
...
ace.define('ace/mode/haskell_cabal', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/haskell_cabal_highlight_rules', 'ace/mode/folding/haskell_cabal'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const CabalHighlightRules = acequire('./haskell_cabal_highlight_rules').CabalHighlightRules;
  const FoldMode = acequire('./folding/haskell_cabal').FoldMode;
