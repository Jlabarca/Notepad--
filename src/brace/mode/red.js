ace.define('ace/mode/red_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextHighlightRules = acequire('./text_highlight_rules').TextHighlightRules;

  const RedHighlightRules = function () {
...
ace.define('ace/mode/red', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/red_highlight_rules', 'ace/mode/folding/cstyle', 'ace/mode/matching_brace_outdent', 'ace/range'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const RedHighlightRules = acequire('./red_highlight_rules').RedHighlightRules;
  const RedFoldMode = acequire('./folding/cstyle').FoldMode;
