...
ace.define('ace/mode/mysql_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/doc_comment_highlight_rules', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
...
ace.define('ace/mode/mysql', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/mysql_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('../mode/text').Mode;
  const MysqlHighlightRules = acequire('./mysql_highlight_rules').MysqlHighlightRules;
