ace.define('ace/mode/eiffel_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
...
ace.define('ace/mode/eiffel', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/eiffel_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const EiffelHighlightRules = acequire('./eiffel_highlight_rules').EiffelHighlightRules;
