...
ace.define('ace/mode/dot_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/text_highlight_rules', 'ace/mode/doc_comment_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
...
ace.define('ace/mode/dot', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/matching_brace_outdent', 'ace/mode/dot_highlight_rules', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const MatchingBraceOutdent = acequire('./matching_brace_outdent').MatchingBraceOutdent;
  const DotHighlightRules = acequire('./dot_highlight_rules').DotHighlightRules;
  const DotFoldMode = acequire('./folding/cstyle').FoldMode;
