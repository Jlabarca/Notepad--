...
ace.define('ace/mode/soy_template_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const HtmlHighlightRules = acequire('./html_highlight_rules').HtmlHighlightRules;

  const SoyTemplateHighlightRules = function () {
...
ace.define('ace/mode/soy_template', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/html', 'ace/mode/soy_template_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const HtmlMode = acequire('./html').Mode;
  const SoyTemplateHighlightRules = acequire('./soy_template_highlight_rules').SoyTemplateHighlightRules;
