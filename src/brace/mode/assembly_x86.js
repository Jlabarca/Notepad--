ace.define('ace/mode/assembly_x86_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
...
ace.define('ace/mode/assembly_x86', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/assembly_x86_highlight_rules', 'ace/mode/folding/coffee'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const AssemblyX86HighlightRules = acequire('./assembly_x86_highlight_rules').AssemblyX86HighlightRules;
