...
ace.define('ace/mode/lean_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/doc_comment_highlight_rules', 'ace/mode/text_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
...
ace.define('ace/mode/lean', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/lean_highlight_rules', 'ace/mode/matching_brace_outdent', 'ace/range'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const leanHighlightRules = acequire('./lean_highlight_rules').leanHighlightRules;
