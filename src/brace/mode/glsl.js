...
ace.define('ace/mode/glsl_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/c_cpp_highlight_rules'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const c_cppHighlightRules = acequire('./c_cpp_highlight_rules').c_cppHighlightRules;
...
ace.define('ace/mode/glsl', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/c_cpp', 'ace/mode/glsl_highlight_rules', 'ace/mode/matching_brace_outdent', 'ace/range', 'ace/mode/behaviour/cstyle', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const CMode = acequire('./c_cpp').Mode;
  const glslHighlightRules = acequire('./glsl_highlight_rules').glslHighlightRules;
  const MatchingBraceOutdent = acequire('./matching_brace_outdent').MatchingBraceOutdent;
  const Range = acequire('../range').Range;
  const CstyleBehaviour = acequire('./behaviour/cstyle').CstyleBehaviour;
  const CStyleFoldMode = acequire('./folding/cstyle').FoldMode;
