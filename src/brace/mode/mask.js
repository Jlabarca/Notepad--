...
ace.define('ace/mode/mask_highlight_rules', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/mode/text_highlight_rules', 'ace/mode/javascript_highlight_rules', 'ace/mode/css_highlight_rules', 'ace/mode/markdown_highlight_rules', 'ace/mode/html_highlight_rules'], (acequire, exports, module) => {
  exports.MaskHighlightRules = MaskHighlightRules;

  const oop = acequire('../lib/oop');
  const lang = acequire('../lib/lang');
  const TextRules = acequire('./text_highlight_rules').TextHighlightRules;
  const JSRules = acequire('./javascript_highlight_rules').JavaScriptHighlightRules;
  const CssRules = acequire('./css_highlight_rules').CssHighlightRules;
  const MDRules = acequire('./markdown_highlight_rules').MarkdownHighlightRules;
  const HTMLRules = acequire('./html_highlight_rules').HtmlHighlightRules;

  let token_TAG = 'keyword.support.constant.language',
  ...
  var Blocks = {
    string(str, next) {
      ...
      if (str.length === 1) {
        const escaped = Token('string.escape', `\\\\${str}`);
    ...
    attribute() {
      return Token(value => (/^x\-/.test(value)
...
ace.define('ace/mode/mask', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/mode/text', 'ace/mode/mask_highlight_rules', 'ace/mode/matching_brace_outdent', 'ace/mode/behaviour/css', 'ace/mode/folding/cstyle'], (acequire, exports, module) => {
  const oop = acequire('../lib/oop');
  const TextMode = acequire('./text').Mode;
  const MaskHighlightRules = acequire('./mask_highlight_rules').MaskHighlightRules;
