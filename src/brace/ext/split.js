ace.define('ace/split', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/lang', 'ace/lib/event_emitter', 'ace/editor', 'ace/virtual_renderer', 'ace/edit_session'], (acequire, exports, module) => {
  ...
  (function () {
    ...
    this.$cloneSession = function (session) {
      ...
      s.$informUndoManager = lang.delayedCall(() => { s.$deltas = []; });
...
ace.define('ace/ext/split', ['require', 'exports', 'module', 'ace/split'], (acequire, exports, module) => {
  module.exports = acequire('../split');
});
(function () {
  ace.acequire(['ace/ext/split'], () => {});
}());
