ace.define('ace/snippets', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/event_emitter', 'ace/lib/lang', 'ace/range', 'ace/anchor', 'ace/keyboard/hash_handler', 'ace/tokenizer', 'ace/lib/dom', 'ace/editor'], (acequire, exports, module) => {
...
ace.define('ace/autocomplete/popup', ['require', 'exports', 'module', 'ace/virtual_renderer', 'ace/editor', 'ace/range', 'ace/lib/event', 'ace/lib/lang', 'ace/lib/dom'], (acequire, exports, module) => {
...
ace.define('ace/autocomplete/util', ['require', 'exports', 'module'], (acequire, exports, module) => {
...
ace.define('ace/autocomplete', ['require', 'exports', 'module', 'ace/keyboard/hash_handler', 'ace/autocomplete/popup', 'ace/autocomplete/util', 'ace/lib/event', 'ace/lib/lang', 'ace/lib/dom', 'ace/snippets'], (acequire, exports, module) => {
  const HashHandler = acequire('./keyboard/hash_handler').HashHandler;
  const AcePopup = acequire('./autocomplete/popup').AcePopup;
  const util = acequire('./autocomplete/util');
  const event = acequire('./lib/event');
  const lang = acequire('./lib/lang');
  const dom = acequire('./lib/dom');
  const snippetManager = acequire('./snippets').snippetManager;
...
ace.define('ace/autocomplete/text_completer', ['require', 'exports', 'module', 'ace/range'], (acequire, exports, module) => {
  const Range = acequire('../range').Range;
...
ace.define('ace/ext/language_tools', ['require', 'exports', 'module', 'ace/snippets', 'ace/autocomplete', 'ace/config', 'ace/lib/lang', 'ace/autocomplete/util', 'ace/autocomplete/text_completer', 'ace/editor', 'ace/config'], (acequire, exports, module) => {
  const snippetManager = acequire('../snippets').snippetManager;
  const Autocomplete = acequire('../autocomplete').Autocomplete;
  const config = acequire('../config');
  const lang = acequire('../lib/lang');
  const util = acequire('../autocomplete/util');

  const textCompleter = acequire('../autocomplete/text_completer');
