ace.define('ace/ext/elastic_tabstops_lite', ['require', 'exports', 'module', 'ace/editor', 'ace/config'], (acequire, exports, module) => {
...
(function () {
  ace.acequire(['ace/ext/elastic_tabstops_lite'], () => {});
}());
