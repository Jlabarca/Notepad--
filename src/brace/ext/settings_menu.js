ace.define('ace/ext/menu_tools/element_generator', ['require', 'exports', 'module'], (acequire, exports, module) => {
...
ace.define('ace/ext/modelist', ['require', 'exports', 'module'], (acequire, exports, module) => {
  const modes = [];
...
ace.define('ace/ext/themelist', ['require', 'exports', 'module', 'ace/lib/fixoldbrowsers'], (acequire, exports, module) => {
...
ace.define('ace/ext/menu_tools/add_editor_menu_options', ['require', 'exports', 'module', 'ace/ext/modelist', 'ace/ext/themelist'], (acequire, exports, module) => {
  module.exports.addEditorMenuOptions = function addEditorMenuOptions(editor) {
    const modelist = acequire('../modelist');
    const themelist = acequire('../themelist');
    editor.menuOptions = {
      setNewLineMode: [{
        textContent: 'unix',
        value: 'unix',
...
ace.define('ace/ext/menu_tools/get_set_functions', ['require', 'exports', 'module'], (acequire, exports, module) => {
...
ace.define('ace/ext/menu_tools/generate_settings_menu', ['require', 'exports', 'module', 'ace/ext/menu_tools/element_generator', 'ace/ext/menu_tools/add_editor_menu_options', 'ace/ext/menu_tools/get_set_functions', 'ace/ace'], (acequire, exports, module) => {
  const egen = acequire('./element_generator');
  const addEditorMenuOptions = acequire('./add_editor_menu_options').addEditorMenuOptions;
  const getSetFunctions = acequire('./get_set_functions').getSetFunctions;
  module.exports.generateSettingsMenu = function generateSettingsMenu(editor) {
    ...
    function wrapElements() {
      ...
      const version = acequire('../../ace').version;
...
ace.define('ace/ext/menu_tools/overlay_page', ['require', 'exports', 'module', 'ace/lib/dom'], (acequire, exports, module) => {
...
ace.define('ace/ext/settings_menu', ['require', 'exports', 'module', 'ace/ext/menu_tools/generate_settings_menu', 'ace/ext/menu_tools/overlay_page', 'ace/editor'], (acequire, exports, module) => {
  const generateSettingsMenu = acequire('./menu_tools/generate_settings_menu').generateSettingsMenu;
  const overlayPage = acequire('./menu_tools/overlay_page').overlayPage;
...
(function () {
  ace.acequire(['ace/ext/settings_menu'], () => {});
}());
