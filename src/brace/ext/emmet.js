...
ace.define('ace/ext/emmet', ['require', 'exports', 'module', 'ace/keyboard/hash_handler', 'ace/editor', 'ace/snippets', 'ace/range', 'resources', 'resources', 'tabStops', 'resources', 'utils', 'actions', 'ace/config', 'ace/config'], (acequire, exports, module) => {
  const HashHandler = acequire('ace/keyboard/hash_handler').HashHandler;
  const Editor = acequire('ace/editor').Editor;
  const snippetManager = acequire('ace/snippets').snippetManager;
  ...
  var load = function (cb) {
    if (typeof emmetPath === 'string') {
      acequire('ace/config').loadModule(emmetPath, () => {
        emmetPath = null;
        cb && cb();
      });
    }
