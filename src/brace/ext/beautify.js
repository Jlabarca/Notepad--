ace.define('ace/ext/beautify/php_rules', ['require', 'exports', 'module', 'ace/token_iterator'], (acequire, exports, module) => {
...
ace.define('ace/ext/beautify', ['require', 'exports', 'module', 'ace/token_iterator', 'ace/ext/beautify/php_rules'], (acequire, exports, module) => {
  const TokenIterator = acequire('ace/token_iterator').TokenIterator;

  const phpTransform = acequire('./beautify/php_rules').transform;
