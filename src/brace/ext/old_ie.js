ace.define('ace/ext/searchbox', ['require', 'exports', 'module', 'ace/lib/dom', 'ace/lib/lang', 'ace/lib/event', 'ace/keyboard/hash_handler', 'ace/lib/keys'], (acequire, exports, module) => {
...
ace.define('ace/ext/old_ie', ['require', 'exports', 'module', 'ace/lib/useragent', 'ace/tokenizer', 'ace/ext/searchbox', 'ace/mode/text'], (acequire, exports, module) => {
  const MAX_TOKEN_COUNT = 1000;
  const useragent = acequire('../lib/useragent');
  const TokenizerModule = acequire('../tokenizer');
  ...
  if (typeof document !== 'undefined' && !document.documentElement.querySelector) {
    ...
    const sb = acequire('./searchbox').SearchBox.prototype;
    patch(
      sb, '$initElements',
      /([^\s=]*).querySelector\((".*?")\)/g,
      'qs($1, $2)',
