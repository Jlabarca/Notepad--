ace.define('ace/keyboard/vim', ['require', 'exports', 'module', 'ace/range', 'ace/lib/event_emitter', 'ace/lib/dom', 'ace/lib/oop', 'ace/lib/keys', 'ace/lib/event', 'ace/search', 'ace/lib/useragent', 'ace/search_highlight', 'ace/commands/multi_select_commands', 'ace/mode/text', 'ace/multi_select'], (acequire, exports, module) => {
  function log() {
    let d = '';
    function format(p) {
  ...
  const multiSelectCommands = acequire('../commands/multi_select_commands');
  const TextModeTokenRe = acequire('../mode/text').Mode.prototype.tokenRe;
      ...
      function parseArgs() {
        if (params.argString) {
          ...
          if (opts) {
            ...
            const decimal = opts.indexOf('d') != -1 && 1;
            const hex = opts.indexOf('x') != -1 && 1;
            const octal = opts.indexOf('o') != -1 && 1;
